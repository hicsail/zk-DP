...
def optimization(US_Hist, noised_H, l1_rate, l1_iter, l2_rate, l2_iter, init_sum):
    ...
    return l2_loss, post_l2_Sum, pre_l1_loss, post_l1_sum, l1_loss
...
l2_loss, post_l2_Sum, pre_l1_loss, post_l1_sum, l1_loss = optimization(US_Hist, noised_H, l1_rate, l1_iter, l2_rate, l2_iter, init_sum)
